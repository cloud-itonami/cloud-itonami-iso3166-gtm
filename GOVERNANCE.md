...
`cloud-itonami-iso3166-gtm` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Guatemalan-licensed counsel or a registered agent for whatever licensed
representation the law of Guatemala requires for public-procurement
filings.
